...
class ChatViewModel with ChangeNotifier {
  ...
  UserRepostory _userRepository = locator<UserRepostory>();
  final MyUser currentUser;
  final MyUser sohbetEdilenUser;
  MessageModel _enSonGetirilenMesaj;
  MessageModel _listeyeEklenenIlkMesaj;
  bool _hasMore = true;
  ...
  List<MessageModel> get mesajlarListesi => _tumMesajlar;
  ...
  Future<bool> saveMessage(MessageModel kaydedilecekMesaj, MyUser currentUser) async {
