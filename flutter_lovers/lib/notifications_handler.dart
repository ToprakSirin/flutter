...
class NotificationHandler {
  ...
  Future onSelectNotification(String payload) async {
    final _userModel = Provider.of<UserViewModel>(myContext);
        ...
        MaterialPageRoute(
          builder: (context) => ChangeNotifierProvider(
            create: (context) => ChatViewModel(
                ...
                sohbetEdilenUser: MyUser.userIdAndProfilPhotoAndUserName(userId: gelenBildirim["data"]["gonderenUserId"], profilURL: gelenBildirim["data"]["profilURL"], )),
            child: KonusmaPage(currentUser: _userModel.user!.userId.,sohbetEdilenUser: _userModel.user!.email.),
          ),
        ),
      );
    }
